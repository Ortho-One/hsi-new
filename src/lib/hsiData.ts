...
export const MEMBERSHIP_TIERS: MembershipTier[] = [
  {
    ...
    appAccess: 'Safeplay App (Athlete Management System)',
    insuranceCoverage: 'Personal Accident up to ₹3L · Medical Expenses up to ₹1L',
    features: [
      '1 Consultation (Sports Medicine / Physiotherapist / Nutrition)',
      'Safeplay App (Athlete Management System)',
  ...
  },
  {
    id: 'pro',
    name: 'Pro Plan',
    subtitle: 'Regular competitive athletes',
    priceYr: 2999,
    originalPrice: 10617,
    popular: true,
    consultations: '2 Consultations (Sports Medicine / Physiotherapist / Nutrition)',
    appAccess: 'Safeplay App (Athlete Management System)',
    insuranceCoverage: 'Personal Accident up to ₹3L · Medical Expenses up to ₹2L',
    features: [
      '2 Consultations (Sports Medicine / Physiotherapist / Nutrition)',
      'Safeplay App (Athlete Management System)',
      'Body Composition Analysis + Basic Fitness (FMS) Assessment',
      'Personal Accident Insurance (up to ₹3 Lakhs)',
  ...
  },
  {
    id: 'elite',
    name: 'Elite Plan',
    subtitle: 'High-performance/Professional athletes',
    priceYr: 7499,
    originalPrice: 27167,
    popular: false,
    consultations: '2 Consultations (Sports Medicine / Physiotherapist / Nutrition)',
    ...
    features: [
      '2 Consultations (Sports Medicine / Physiotherapist / Nutrition)',
      'Complete Fitness Assessment + BCA',
      'Diet Plan, Blood Investigation, ECG & Chest X-ray',
      'Safeplay App (Athlete Management System)',
      'Personal Accident Insurance (up to ₹3 Lakhs)',
      'Medical Expense Coverage (up to ₹2 Lakhs)'
    ],
